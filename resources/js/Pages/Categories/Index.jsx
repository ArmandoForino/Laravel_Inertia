                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            ...
                            {addingMode&&!editingMode&&<Form setAddingMode={setAddingMode} domain="categories" action='store'/>}

                            {!addingMode&&editingMode&&<Form category={editingCategory} setCategory={handleEdit} domain="categories"  action='update' />}
